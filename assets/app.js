		...
		tooltipIni: function(tooltip, productTooltip) {
			...
			if ($(productTooltip).length) {
				...
				if (!$body.hasClass('touch')) {
					$(productTooltip).on('mouseenter', function() {
						if (!$(this).closest('li').hasClass('active')) {
							$(this).tooltip('show');
						}
				...
				$(productTooltip).on('click touchstart', function() {
					$(this).tooltip('show');
		...
		swatchToggle: function(option) {
			$(option).each(function() {
				...
				$optionbtn.on('click touchstart', function(e) {
					var $this = $(this),
						currentSelect = $this.attr('data-image').split('products/').pop().split('.').shift(),
					...
					if ($this.attr('data-image')) {
						if (($previewsCarousel.length && w < maxSM) || ($previewsCarousel.length && !$productGalleryM.length)) {
							$previewsCarousel.find('.slick-slide').each(function(i) {
								if ($(this).attr('data-name') == currentSelect) {
									$(this).trigger('click');
