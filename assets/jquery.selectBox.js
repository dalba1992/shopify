...
;(function ($) {
    ...
    SelectBox.prototype.showMenu = function () {
        ...
        options
            ...
            .addClass('selectBox-options selectBox-options-'+(posTop?'top':'top'));
        ...
        this.addHover(li);
        control.addClass('selectBox-menuShowing selectBox-menuShowing-'+(posTop?'top':'top'));
    ...
    SelectBox.prototype.hideMenus = function () {
        ...
        $(".selectBox-dropdown-menu").each(function () {
            ...
            if (settings) {
                ...
                control.removeClass('selectBox-menuShowing selectBox-menuShowing-'+(posTop?'top':'top'));
                ...
                $(this).removeClass('selectBox-menuShowing selectBox-menuShowing-'+(posTop?'top':'top'));
                /*$(this).removeClass('selectBox-menuShowing selectBox-menuShowing-'+(posTop?'top':'bottom'));*/
            }

            options.css('max-height','');
            //Remove Top or Bottom class based on position
            options.removeClass('selectBox-options-'+(posTop?'top':'top'));
            /*options.removeClass('selectBox-options-'+(posTop?'top':'bottom'));*/
            options.data('posTop' , true);
        });
    };
